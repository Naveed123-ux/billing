              ...
              <div class="col-lg-6" data-aos="fade-left" data-aos-delay="300">
                <div class="about-content">
                  ...
                  <p>
                    ...
                    Proin consequat magna eu accumsan mattis. Duis non augue in
                    tortor facilisis tincidunt ac sit amet sapien. Suspendisse
                    id risus non nisi sodales condimentum.
                  </p>
              ...
              >
                <div class="department-card">
                  ...
                  <div class="department-content">
                    ...
                    <h3>Orthopedics</h3>
                    <p>
                      Advanced musculoskeletal care focusing on bones, joints,
                ...
                <div class="service-card">
                  ...
                  <div class="service-content">
                    ...
                    <ul class="service-features">
                      <li>
                        <i class="fas fa-check-circle"></i>Advanced Heart
                        Surgery
                      </li>
                      <li>
                ...
                <div class="service-card">
                  ...
                  <div class="service-content">
                    ...
                    <ul class="service-features">
                      ...
                      <li>
                        <i class="fas fa-check-circle"></i>Stroke Treatment
                        Center
                      </li>
                      <li>
            ...
            <div class="row justify-content-center">
              <div class="col-lg-8 text-center">
                ...
                >
                  ...
                  <a href="doctors.html" class="btn-secondary">
                    Find a Doctor
                  </a>
                </div>
              </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <ul class="emergency-list">
                        ...
                        <li>
                          <i class="bi bi-check-circle"></i> Loss of
                          consciousness
                        </li>
                        <li>
                          <i class="bi bi-check-circle"></i> Severe abdominal
                          pain
                        </li>
                        <li>
